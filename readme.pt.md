...
Agora que já sabemos criar e apagar ficheiros podemos passar a aprender a copiá-los com o `cp`
  (**c**o**p**y).
Cria um ficheiro novo com o `touch`, abre-o num editor de texto, e mete um texto qualquer lá.
...
Se alguma parte do guia não está bem, ou se achas que algo pode ser melhorado ou acrescentado, [cria
  um issue](https://github.com/PillTime/term-intro/issues/new).
